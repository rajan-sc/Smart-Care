    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-linen-white">
      <div className="w-full max-w-sm animate-fade-in relative z-10">
        ...
        <div className="flex items-center gap-3 mb-10">
          <div className="w-10 h-10 rounded-cards flex items-center justify-center flex-shrink-0 bg-mist-blue">
            <svg className="w-5 h-5 text-forest-ink" viewBox="0 0 24 24" fill="none"
              stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round">
              <path d="M22 12h-4l-3 9L9 3l-3 9H2" />
            </svg>
          </div>
          <span className="text-xl font-bold tracking-tight text-forest-ink">
            Smart Care
          </span>
        </div>
